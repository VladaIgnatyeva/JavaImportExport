...
public class ShowImportByDateHandler implements Handler {
    private ImportRepository import_sRepository;

    public ShowImportByDateHandler(ImportRepository import_sRepository){
    ...
    public Object handle(String data) throws IOException {
        ...
        ArrayList<ImportForTable> import_s = import_sRepository.getImportByDate(import_.getImport());
