...
public class ShowExportByDateHandler implements Handler {
    private ExportRepository exportsRepository;

    public ShowExportByDateHandler(ExportRepository exportsRepository){
    ...
    public Object handle(String data) throws IOException {
        ...
        ArrayList<ExportForTable> exports = exportsRepository.getExportByDate(export.getExport());
